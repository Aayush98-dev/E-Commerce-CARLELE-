...
const Bottom = () => {
    return (
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32 mmt-60 text-sm text-gray-500 w-full">
            <div className="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-500/30">

                <div className="max-w-96">
                    <a href = "/">
                        <img src={assets.lg2} alt="" className='max-w-56'/>
                    </a>
                    <p className="mt-6 text-sm text-gray-500">
                        Premium car rental services witha wide selection of luxury and everyday vehicles for all your driving needs.
                    </p>
            ...
            <p className="py-4 text-center text-xs md:text-sm text-gray-500">
                Copyright 2025 © <a href="/">CarLELO</a>. All Right Reserved.
            </p>
        </footer>
    )
}
