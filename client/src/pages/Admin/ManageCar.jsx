...
const ManageCar = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title title="Manage Cars" subTitle="Viw all listed cars, update their details, or remove them from the booking platform." />
            ...
            {cars.map((car, index)=>(
              <tr key={index} className='border-t border-borderColor'>
                ...
                <td className='p-3 max-md:hidden'>
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs 
                    ${(car.isAvailable || car.isAvaliable) ? 'bg-green-100 text-green-500' : 'bg-red-100 text-red-500'}`}>
                ...
                <td className='flex items-center p-3'>
                  ...
                  <img onClick={()=>toggleAvailability(car._id)} src={(car.isAvailable || car.isAvaliable) ? assets.eye_close_icon : assets.eye_icon} alt="" className='cursor-pointer'/>
