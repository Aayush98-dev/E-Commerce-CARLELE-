...
const Control = () => {
  ...
  const dashboardCard = [
    {title: "Total Cars" , value: safeData?.totalCars ?? 0, icon: assets.carIconColored},
    {title: "Total Booking" , value: safeData?.totalBookings ?? 0, icon: assets.listIconColored},
    {title: "Pending" , value: safeData?.pendingBookings ?? 0, icon: assets.cautionIconColored},
    {title: "Confirmed" , value: safeData?.completedBookings ?? 0, icon: assets.listIconColored},
  ]
    ...
    <div className='px-4 pt-10 md:px-10 flex-1'>
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
        ...
        <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md w-full md:max-w-xs'>
         ...
         {data && data.monthlyRevenue !== undefined ? (
         <p className='text-3xl mt-6 font-semibold text-primary'>{currency} {data.monthlyRevenue}</p>
         ) : (
           <p className='text-3xl mt-6 font-semibold text-gray-400'>Loading...</p> // Or any other loading indicator
         )}
        </div>
      </div>
