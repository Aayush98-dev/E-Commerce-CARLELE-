...
const Add = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add new Car" subTitle="Fill the Details to list a new car" />
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='flex items-center gap-2 w-full'>
          ...
          <p className='text-sm text-gray-500'>Upload Image of your Car</p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            <label>Brand</label>
            <input type="text" placeholder='e.g BMW, TATA, MAHINDRA' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.brand} onChange={e => setCar({ ...car, brand: e.target.value })} />
          </div>
          <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type="text" placeholder='e.g Model names' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
        ...
        {/* Car description lelo */}
        <div className='flex flex-col w-full'>
          <label>Description</label>
          <textarea rows={5} placeholder='e.g. A luxirious Car Collections' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
